...
const Connections = () => {
  ...
  const [currentUser] = useState(localStorage.getItem("agentUsername") || "Agent");
  ...
  const connections = [
    ...
    { id: 3, name: "Customer", role: "Customer", status: "Connected", image: "" },
  ];

  const recommendations = [
    { id: 4, name: "Organic Fields", role: "Farmer", status: "Recommended", image: "" },
    { id: 5, name: "customer1", role: "Customer", status: "Recommended", image: "" },
  ];
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your network of farmers and customers</p>
      </div>
