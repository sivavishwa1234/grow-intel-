...
const Connections = () => {
  ...
  const [currentUser] = useState(localStorage.getItem("customerUsername") || "Customer");
  ...
  const connections = [
    { id: 1, name: "Farmer John", role: "Farmer", status: "Connected", image: "" },
    { id: 2, name: "Green Valley Farm", role: "Farmer", status: "Connected", image: "" },
    { id: 3, name: "Agent Smith", role: "Agent", status: "Connected", image: "" },
  ];

  const recommendations = [
    { id: 4, name: "Organic Fields", role: "Farmer", status: "Recommended", image: "" },
    { id: 5, name: "Agent Brown", role: "Agent", status: "Recommended", image: "" },
  ];
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your network of farmers and agents</p>
      </div>
